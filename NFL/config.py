...
def load_elo_settings(filename=SETTINGS_FILE):
    defaults = {
        "base_rating": 1500.0, "k": 17.30, "home_adv": 18.12,
        "use_mov": True, "autoresolve_enabled": False,
        "player_boost": 26.52, "rest_factor": 30.0, "form_weight": 16.38,
        "travel_factor": 25.0, "sos_factor": 20.0,
        "playoff_hca_factor": 2.0, "pace_factor": 4.0,
        "division_factor": 30.85, "mean_reversion": 17.21,
        "b2b_penalty": 3.93, "road_trip_factor": 0.0,
        "homestand_factor": 32.0, "win_streak_factor": 32.0,
        "altitude_factor": 0.67, "season_phase_factor": 32.0,
        "scoring_consistency_factor": 5.0, "rest_advantage_cap": 7.0,
        "bye_week_factor": 0.0,
        "season_regress": 0.33,
