...
def show_help(topic=""):
    ...
    if not topic:
        hdr("NFL SHARPSTACK - PREDICTS $1 TRACKER  .  HELP")
        print("""
...
""")
        ...
        cmds = [
            ...
            ("players",            "Show top players (league or per team)"),
    ...
    if topic == "advanced":
        ...
        section("superopt", "superopt",
                ...
                notes=["Searches ALL 9 tunable params (K, HA, PB, Rest, Travel, Pace, PHCA, SOS, Form)",
                       ...
                       "Settings auto-saved to nfl_elo_settings.json (loads on every start)",
        ...
        section("platt / calibrate", "platt",
                ...
                notes=[
                    ...
                    "Saved to nfl_platt_scaler.json, loaded automatically on startup",
        ...
        section("<team name>", "chiefs  OR  eagles  OR  any team name fragment",
