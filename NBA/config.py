...
BACKTEST_FILE           = "nba_backtest_predictions.csv"
...
def load_elo_settings(filename=SETTINGS_FILE):
    defaults = {
        "base_rating": 1500.0, "k": 8.53, "home_adv": 31.99,
        "use_mov": True, "autoresolve_enabled": False,
        "player_boost": 48.0, "rest_factor": 18.21, "form_weight": 5.06,
        "travel_factor": 12.20, "sos_factor": 2.0,
        "playoff_hca_factor": 0.71, "pace_factor": 26.53,
        "starting_balance": 0.0, "kelly_fraction": 0.50,
        "auto_kalshi": False,
        "division_factor": 10.0, "mean_reversion": 0.0,
        "b2b_penalty": 0.0, "road_trip_factor": 5.0,
        "homestand_factor": 15.0, "win_streak_factor": 0.0,
        "altitude_factor": 0.04, "season_phase_factor": 0.0,
        "scoring_consistency_factor": 0.0, "rest_advantage_cap": 2.47,
        "season_regress": 0.33,
    }
