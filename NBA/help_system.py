...
def show_help(topic=""):
    ...
    if not topic:
        hdr("NBA SHARPSTACK - PREDICTS $1 TRACKER  .  HELP")
        print("""
...
""")
        ...
        div(W)
        data_cmds = [
            ("odds",               "Show current betting odds for today's NBA games"),
            ("weather",            "Show weather report for home arena (limited for indoor NBA)"),
            ...
            ("tomorrow",           "Generate HTML prediction table for tomorrow's NBA games"),
        ]
    ...
    if topic == "advanced":
        ...
        section("superopt", "superopt",
                ...
                notes=["Searches ALL 9 tunable params (K, HA, PB, Rest, Travel, Pace, PHCA, SOS, Form)",
                       ...
                       "Settings auto-saved to nba_elo_settings.json (loads on every start)",
        ...
        section("platt / calibrate", "platt",
                ...
                notes=[
                    ...
                    "Saved to nba_platt_scaler.json, loaded automatically on startup",
        ...
        section("<team name>", "lakers  OR  celtics  OR  any team name fragment",
        ...
        section("settings / set", "settings  OR  set k=28  OR  set home=60",
                ...
                examples=["set k=13.3", "set home=39.3", "set boost=8.8", "set sos=10",
                           "set form=5", "settings"])
        ...
        section("odds", "odds",
                "Show current betting odds for today's NBA games.",
        ...
        section("weather", "weather",
                ...
                notes=["NBA is played indoors — weather has minimal game impact",
        ...
        section("injuries", "injuries  OR  injuries set <team> <player1>, <player2>",
                "Show injury report with Elo impact estimates.",
                notes=["Fetches current injury data from ESPN",
                       "Shows per-team injury impact in Elo points (via player_boost)",
                       ...
                       "Impact scales with player_boost parameter (current setting in 'settings')"])
    elif topic == "balance":
        ...
        section("tomorrow", "tomorrow",
                "Generate HTML prediction table for tomorrow's NBA games.",
                notes=["Same as 'today' but fetches tomorrow's schedule",
                       "Saves to today_nba_predictions.html (same file, overwritten)",
