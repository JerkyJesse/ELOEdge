"""
Moedim System Model -- 36th mega-ensemble model (NBA)
...
# ---------------------------------------------------------------------------
# NBA team founding dates (franchise establishment year)
# Uses the earliest continuous franchise date for each current team
# ---------------------------------------------------------------------------
FOUNDING_DATES = {
    "ATL": "1946-11-01",   # Atlanta Hawks (Tri-Cities Blackhawks 1946, BAA)
    "BOS": "1946-06-06",   # Boston Celtics (BAA charter 1946)
    "BKN": "1967-02-06",   # Brooklyn Nets (NJ Americans, ABA 1967)
    "CHA": "1988-11-04",   # Charlotte Hornets (expansion 1988)
    "CHI": "1966-01-16",   # Chicago Bulls (expansion 1966)
    "CLE": "1970-02-06",   # Cleveland Cavaliers (expansion 1970)
    "DAL": "1980-05-01",   # Dallas Mavericks (expansion 1980)
    "DEN": "1967-02-06",   # Denver Nuggets (Rockets, ABA 1967)
    "DET": "1941-01-01",   # Detroit Pistons (Fort Wayne Zollner Pistons 1941, NBL)
    "GSW": "1946-06-06",   # Golden State Warriors (Philadelphia Warriors, BAA 1946)
    "HOU": "1967-10-01",   # Houston Rockets (San Diego Rockets 1967)
    "IND": "1967-02-06",   # Indiana Pacers (ABA 1967)
    "LAC": "1970-02-06",   # LA Clippers (Buffalo Braves 1970)
    "LAL": "1947-06-01",   # LA Lakers (Minneapolis Lakers, NBL 1947)
    "MEM": "1995-06-15",   # Memphis Grizzlies (Vancouver Grizzlies 1995)
    "MIA": "1988-11-04",   # Miami Heat (expansion 1988)
    "MIL": "1968-01-22",   # Milwaukee Bucks (expansion 1968)
    "MIN": "1989-04-17",   # Minnesota Timberwolves (expansion 1989)
    "NOP": "2002-10-29",   # New Orleans Pelicans (Hornets expansion 2002)
    "NYK": "1946-06-06",   # New York Knicks (BAA charter 1946)
    "OKC": "1967-10-01",   # OKC Thunder (Seattle SuperSonics 1967)
    "ORL": "1989-04-17",   # Orlando Magic (expansion 1989)
    "PHI": "1939-01-01",   # Philadelphia 76ers (Syracuse Nationals, NBL 1939)
    "PHX": "1968-01-22",   # Phoenix Suns (expansion 1968)
    "POR": "1970-02-06",   # Portland Trail Blazers (expansion 1970)
    "SAC": "1945-01-01",   # Sacramento Kings (Rochester Royals, NBL 1945)
    "SAS": "1967-02-06",   # San Antonio Spurs (Dallas Chaparrals, ABA 1967)
    "TOR": "1995-11-03",   # Toronto Raptors (expansion 1995)
    "UTA": "1974-06-07",   # Utah Jazz (New Orleans Jazz 1974)
    "WAS": "1961-01-11",   # Washington Wizards (Chicago Packers 1961)
}
...
class LeagueMoedim:
    """League-wide Moedim System tracking for NBA."""
