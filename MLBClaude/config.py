...
def load_elo_settings(filename=SETTINGS_FILE):
    defaults = {
        "base_rating": 1500.0, "k": 6.0, "home_adv": 25.0,
        "use_mov": True, "autoresolve_enabled": False,
        "player_boost": 3.0, "starter_boost": 10.0,
        "rest_factor": 5.0, "form_weight": 3.0,
        "travel_factor": 5.0, "sos_factor": 5.0,
        "playoff_hca_factor": 0.95, "pace_factor": 9.0,
        "division_factor": 7.0, "mean_reversion": 5.0,
        "pyth_factor": 8.0, "home_road_factor": 4.0, "mov_base": 0.5,
        "season_regress": 0.33,
        "b2b_penalty": 42.0, "road_trip_factor": 2.0,
        "homestand_factor": 2.0, "win_streak_factor": 2.0,
        "altitude_factor": 5.0, "season_phase_factor": 5.0,
        "scoring_consistency_factor": 1.5, "rest_advantage_cap": 1.5,
        "park_factor_weight": 3.5,
        "mov_cap": 15.0, "east_travel_penalty": 2.0,
        "series_adaptation": 3.0, "interleague_factor": 2.0,
        "bullpen_factor": 8.0, "opp_pitcher_factor": 10.0,
        "k_decay": 1.5, "surprise_k": 1.5,
        "elo_scale": 400.0,
