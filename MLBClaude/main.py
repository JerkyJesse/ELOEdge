...
def main():
    print(Back.GREEN + Fore.BLACK + Style.BRIGHT
          + "  MLB MONEYBALL + PREDICTS $1 CONTRACT TRACKER  [v3 - Elo+XGBoost ensemble]  "
          + Style.RESET_ALL)
    div(80)
    print("""
WORKFLOW:
...
COMMANDS: teamname | all | refresh | backtest | enhanced | platt | grid | genetic
          ...
          injuries       Show MLB injury report with Elo impact estimates
          ...
          set k=4 | set home=24 | set boost=0 | set rest=5
