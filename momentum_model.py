...
class LeagueMomentum:
    ...
    def __init__(self, friction=0.05, min_games=5):
        self.friction = friction
        self.min_games = min_games
        self.teams = defaultdict(lambda: TeamMomentum(friction=friction, min_games=min_games))
