#!/usr/bin/env python3
"""
NHL ELOEdge -- Elo-only predictions + Predicts $1 contract tracker.
Goalie starts, back-to-back travel penalties, Platt-calibrated.
"""
...
SETTINGS (39 Elo params, type 'set' to see all):
  set k=8 | set home=25 | set boost=20 | set rest=15 | set b2b=10
  set travel=20 | set pace=20 | set sos=10 | set streak=5
