...
2. **XGBoost ensemble** (`enhanced_model.py`) -- 80% Elo / 20% XGBoost using 96 rolling features per team (10-game window via `TeamTracker`, includes Pythagorean win expectation, streaks, consistency, and trend)
