"""
Moedim System Model -- 36th mega-ensemble model (NHL)
...
# ---------------------------------------------------------------------------
# NHL team founding dates (franchise establishment year)
# Uses the earliest continuous franchise date for each current team
# ---------------------------------------------------------------------------
FOUNDING_DATES = {
    "ANA": "1993-06-15",   # Anaheim Ducks (Mighty Ducks, expansion 1993)
    "BOS": "1924-11-01",   # Boston Bruins (1924)
    "BUF": "1970-05-22",   # Buffalo Sabres (expansion 1970)
    "CGY": "1972-06-06",   # Calgary Flames (Atlanta Flames 1972)
    "CAR": "1972-06-06",   # Carolina Hurricanes (New England Whalers, WHA 1972)
    "CHI": "1926-09-25",   # Chicago Blackhawks (1926)
    "COL": "1972-06-22",   # Colorado Avalanche (Quebec Nordiques, WHA 1972)
    "CBJ": "2000-06-12",   # Columbus Blue Jackets (expansion 2000)
    "DAL": "1967-06-05",   # Dallas Stars (Minnesota North Stars 1967)
    "DET": "1926-09-25",   # Detroit Red Wings (Cougars 1926)
    "EDM": "1972-11-01",   # Edmonton Oilers (WHA 1972)
    "FLA": "1993-06-14",   # Florida Panthers (expansion 1993)
    "LA":  "1967-06-05",   # LA Kings (expansion 1967)
    "MIN": "2000-06-25",   # Minnesota Wild (expansion 2000)
    "MTL": "1909-12-04",   # Montreal Canadiens (NHA 1909)
    "NSH": "1998-06-25",   # Nashville Predators (expansion 1998)
    "NJ":  "1974-06-11",   # New Jersey Devils (Kansas City Scouts 1974)
    "NYI": "1972-06-06",   # New York Islanders (expansion 1972)
    "NYR": "1926-05-15",   # New York Rangers (1926)
    "OTT": "1992-06-18",   # Ottawa Senators (expansion 1992)
    "PHI": "1967-06-05",   # Philadelphia Flyers (expansion 1967)
    "PIT": "1967-06-05",   # Pittsburgh Penguins (expansion 1967)
    "SJ":  "1991-05-09",   # San Jose Sharks (expansion 1991)
    "SEA": "2021-07-01",   # Seattle Kraken (expansion 2021)
    "STL": "1967-06-05",   # St. Louis Blues (expansion 1967)
    "TB":  "1992-12-16",   # Tampa Bay Lightning (expansion 1992)
    "TOR": "1917-11-26",   # Toronto Maple Leafs (Arenas, NHL charter 1917)
    "UTA": "1979-06-22",   # Utah Hockey Club (Winnipeg Jets -> Arizona Coyotes 1979)
    "VAN": "1970-05-22",   # Vancouver Canucks (expansion 1970)
    "VGK": "2017-06-22",   # Vegas Golden Knights (expansion 2017)
    "WSH": "1974-06-11",   # Washington Capitals (expansion 1974)
    "WPG": "1999-06-25",   # Winnipeg Jets (Atlanta Thrashers 1999)
}
...
class LeagueMoedim:
    """League-wide Moedim System tracking for NHL."""
