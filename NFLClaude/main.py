...
def main():
    print(Back.GREEN + Fore.BLACK + Style.BRIGHT
          + "  NFL MONEYBALL + PREDICTS $1 CONTRACT TRACKER  [v3 - Elo+XGBoost ensemble]  "
          + Style.RESET_ALL)
    div(80)
    print("""
WORKFLOW:
...
COMMANDS: teamname | all | refresh | backtest | enhanced | platt | grid | genetic
          ...
          set k=20 | set home=48 | set boost=25 | set rest=40
          set b2b=10 | set roadtrip=5 | set homestand=5 | set streak=10
          set altitude=1.0 | set phase=10 | set consistency=5 | set restcap=14
          set bye=15 | set division=5 | set reversion=5
