...
class LeagueNetwork:
    ...
    def __init__(self, decay=0.95, margin_weighted=True):
        """
        Args:
    ...
    def compute_centralities(self, alpha=0.85):
        ...
        try:
            self._pagerank = nx.pagerank(self.graph, alpha=alpha, weight="weight")
