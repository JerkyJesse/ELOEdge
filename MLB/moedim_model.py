"""
Moedim System Model -- 36th mega-ensemble model (MLB)
...
# ---------------------------------------------------------------------------
# MLB team founding dates (franchise establishment year)
# Uses the earliest continuous franchise date for each current team
# ---------------------------------------------------------------------------
FOUNDING_DATES = {
    "AZ":  "1998-03-31",   # Arizona Diamondbacks (expansion 1998)
    "ATL": "1871-03-17",   # Atlanta Braves (Boston Red Stockings 1871)
    "BAL": "1901-04-26",   # Baltimore Orioles (Milwaukee Brewers AL 1901)
    "BOS": "1901-04-26",   # Boston Red Sox (Americans 1901)
    "CHC": "1876-04-25",   # Chicago Cubs (White Stockings NL 1876)
    "CWS": "1901-04-24",   # Chicago White Sox (1901)
    "CIN": "1881-05-02",   # Cincinnati Reds (1881 NL entry)
    "CLE": "1901-04-24",   # Cleveland Guardians (Blues/Naps 1901)
    "COL": "1993-04-05",   # Colorado Rockies (expansion 1993)
    "DET": "1901-04-25",   # Detroit Tigers (1901)
    "HOU": "1962-04-10",   # Houston Astros (Colt .45s 1962)
    "KC":  "1969-04-08",   # Kansas City Royals (expansion 1969)
    "LAA": "1961-04-11",   # Los Angeles Angels (expansion 1961)
    "LAD": "1883-05-12",   # Los Angeles Dodgers (Brooklyn Atlantics 1883)
    "MIA": "1993-04-05",   # Miami Marlins (expansion 1993)
    "MIL": "1969-04-08",   # Milwaukee Brewers (Seattle Pilots 1969)
    "MIN": "1901-04-26",   # Minnesota Twins (Washington Senators 1901)
    "NYM": "1962-04-11",   # New York Mets (expansion 1962)
    "NYY": "1901-04-26",   # New York Yankees (Baltimore Orioles AL 1901)
    "ATH": "1901-04-26",   # Oakland Athletics (Philadelphia A's 1901)
    "PHI": "1883-05-01",   # Philadelphia Phillies (1883)
    "PIT": "1882-04-15",   # Pittsburgh Pirates (Alleghenys 1882)
    "SD":  "1969-04-08",   # San Diego Padres (expansion 1969)
    "SF":  "1883-05-01",   # San Francisco Giants (NY Gothams 1883)
    "SEA": "1977-04-06",   # Seattle Mariners (expansion 1977)
    "STL": "1882-05-02",   # St. Louis Cardinals (Brown Stockings 1882)
    "TB":  "1998-03-31",   # Tampa Bay Rays (Devil Rays 1998)
    "TEX": "1961-04-10",   # Texas Rangers (Washington Senators II 1961)
    "TOR": "1977-04-07",   # Toronto Blue Jays (expansion 1977)
    "WSH": "1969-04-08",   # Washington Nationals (Montreal Expos 1969)
}
...
class LeagueMoedim:
    """League-wide Moedim System tracking for MLB."""
